...
export default function About() {
    return (
        <div className='about d-flex justify-content-between align-items-center w-100  my-5'>
            ...
            <div className="about__left-bg d-flex justify-content-around align-items-start flex-column h-100 w-100 p-5">
                <h1 className='about__title fw-bold lh-base '>شرکتی که در زمینه خدمات و نگهداری فعالیت دارد.</h1>
